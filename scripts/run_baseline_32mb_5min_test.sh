...
echo -e "${CYAN}════════════════════════════════════════════════════════════${NC}"
echo -e "${CYAN}    Baseline Performance Test - 32MB Buffer, 8 Shards      ${NC}"
echo -e "${CYAN}    100 Concurrent Threads, 1000 RPS, 300KB Logs, 5min  ${NC}"
echo -e "${CYAN}════════════════════════════════════════════════════════════${NC}"
echo ""

# Configuration
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
RESULTS_DIR="results/baseline_32mb_8s_100t_5min"
CONTAINER_NAME="grpc-server-baseline-32mb"
SERVER_PORT=8585
RPS=1000
DURATION="5m"
THREADS=100
