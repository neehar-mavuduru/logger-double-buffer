#!/bin/bash
# test_50t_4s.sh
# Test 50 threads with 4 shards (12.5 threads/shard - optimal ratio)
# Goal: Find optimal config for 50-thread workload

set -e

# Configuration
CONTAINER_NAME="test-50t-4s"
RESULTS_DIR="results/thread_scale_50t_4s"
TEST_DURATION="10m"
RPS=1000
THREADS=50
BUFFER_SIZE="64MB"
...
# Start
print_header "Thread Scaling: 50 Threads / 4 Shards (12.5 T/S)"
...
echo -e "  - Expected: Best performance for 50 threads"
echo ""
...
print_step "Starting server container with 50T / 64MB / 4S..."
...
# Final summary
print_header "✓✓✓ 50T / 4S TEST COMPLETE! ✓✓✓"
echo ""
