#!/bin/bash
# test_32mb_buffer.sh
# Test even smaller buffer (32MB) to find the true optimal size
# Goal: Confirm if smaller continues to be better or if we hit overhead wall

set -e

# Configuration
CONTAINER_NAME="test-32mb-buffer"
RESULTS_DIR="results/buffer_32mb"
TEST_DURATION="10m"
RPS=1000
THREADS=100
BUFFER_SIZE="32MB"
...
# Start
print_header "32MB Buffer Test - Finding the Optimal Size"
...
echo -e "  - Buffer: ${BUFFER_SIZE} (0.5× 64MB), Shards: ${SHARDS}"
echo -e "  - Expected: Even faster writes, confirming optimal size"
echo ""
...
print_step "Starting server container with 32MB buffer..."
...
# Final summary
print_header "✓✓✓ 32MB BUFFER TEST COMPLETE! ✓✓✓"
echo ""
