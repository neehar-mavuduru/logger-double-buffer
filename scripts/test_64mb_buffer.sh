#!/bin/bash
# test_64mb_buffer.sh
# Test smaller buffer (64MB) for faster individual writes
# Goal: Faster writes may compensate for more frequent flushes

set -e

# Configuration
CONTAINER_NAME="test-64mb-buffer"
RESULTS_DIR="results/buffer_64mb"
TEST_DURATION="10m"
RPS=1000
THREADS=100
BUFFER_SIZE="64MB"
...
# Start
print_header "64MB Buffer Test - Faster Individual Writes"
...
echo -e "  - Buffer: ${BUFFER_SIZE} (0.5× baseline), Shards: ${SHARDS}"
echo -e "  - Expected: Faster writes but more frequent flushes"
echo ""
...
print_step "Starting server container with 64MB buffer..."
...
# Final summary
print_header "✓✓✓ 64MB BUFFER TEST COMPLETE! ✓✓✓"
echo ""
