#!/bin/bash
# test_200t_16s.sh
# Test 200 threads with 16 shards (12.5 threads/shard - optimal ratio)
# Goal: Validate large deployment configuration

set -e

# Configuration
CONTAINER_NAME="test-200t-16s"
RESULTS_DIR="results/thread_scale_200t_16s"
TEST_DURATION="10m"
RPS=1000
THREADS=200
BUFFER_SIZE="64MB"
...
# Start
print_header "Thread Scaling: 200 Threads / 16 Shards (12.5 T/S)"
...
echo -e "  - Thread/Shard Ratio: 12.5 (matches proven sweet spot)"
echo -e "  - Expected: Validate large deployment performance"
echo ""
...
print_step "Starting server container with 200T / 64MB / 16S..."
...
# Final summary
print_header "✓✓✓ 200T / 16S TEST COMPLETE! ✓✓✓"
echo ""
